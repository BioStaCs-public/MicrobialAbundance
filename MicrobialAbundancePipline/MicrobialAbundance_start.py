...
from MicrobialAbundance_human_start import HostSequencesRemoving,MicrobialTaxasQuantification

# Pipeline identifier
flag = 'MicrobialAbundance'
...
## MicrobialAbundance_v1.0
def MicrobialAbundance():
    """
